...
import Tsparticles from "../components/Tsparticles.jsx";
  ...
  return (
    ...
    >
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold dark:text-[#ECEEFF] ">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 dark:bg-black dark:text-[#ECEEFF]">
            The New Arrival
          </span>
          <br />
